...
const links=[['/dashboard','Dashboard'],['/tasks','Tasks'],['/customers','Customers'],['/invoices','Invoices'],['/inventory','Inventory'],['/employees','Employees'],['/transactions','Finances'],['/reports','Reports']];
